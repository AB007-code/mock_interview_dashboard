...
export const generator: CreateWorkflowDTO = {
  ...
  nodes: [
      ...
      variableExtractionPlan: {
        output: [
          ...
          },
          {
            ...
            title: "amount",
            description:
              "How many questions would you like to prepare for you? ",
          },
          {
            enum: [],
            type: "string",
    ...
    {
      name: "apiRequest_1752528582781",
      type: "tool",
      metadata: {
        position: {
          x: -423.1599337239413,
          y: 167.45457016904888,
        },
      },
      tool: {
        type: "apiRequest",
  ...
  edges: [
    {
      from: "introduction",
      to: "apiRequest_1752528582781",
      condition: {
        type: "ai",
        prompt: "f user provided all the variables.",
      },
    },
    {
      from: "apiRequest_1752528582781",
      to: "Hangup",
      condition: {
        type: "ai",
        prompt: "",
